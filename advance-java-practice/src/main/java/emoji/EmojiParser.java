...
public class EmojiParser {
    ...
    /**
     * See {@link #parseToAliases(String, emoji.EmojiParser.FitzpatrickAction)} with the action "PARSE"
     *
    ...
    public static String parseToAliases(String input, FitzpatrickAction fitzpatrickAction) {
        ...
        System.out.println("mn : " + EmojiManager.getAll());
    ...
    /**
     * See {@link #parseToHtmlDecimal(String, emoji.EmojiParser.FitzpatrickAction)} with the action "PARSE"
     *
     * @param input the string to parse
     *
    ...
    /**
     * See {@link #parseToHtmlHexadecimal(String, emoji.EmojiParser.FitzpatrickAction)} with the action "PARSE"
     *
     * @param input the string to parse
     *
