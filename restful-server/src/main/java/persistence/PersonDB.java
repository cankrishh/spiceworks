...
public class PersonDB {
    ...
    static {
        ...
        persons.put(2, new Person(2, "FN2", "LN2", "email1@email.com"));
        persons.put(3, new Person(3, "FN3", "LN3", "email1@email.com"));
        persons.put(4, new Person(4, "FN4", "LN4", "email1@email.com"));
        persons.put(5, new Person(5, "FN5", "LN5", "email1@email.com"));
    }
